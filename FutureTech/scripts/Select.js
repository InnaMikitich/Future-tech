      ...
      /*const updateButton = () => {
        ...
        const updateButton = () => {
            if (selectedOptionElement) {
                ...
                this.buttonElement.setAttribute(this.stateAttributes.ariaExpanded, String(isExpanded));
                if (currentOptionIndex !== null && currentOptionIndex >= 0 && this.optionElements[currentOptionIndex]) {
                    const activeDescendantId = this.optionElements[currentOptionIndex].id;
                    if (activeDescendantId) {
                        this.buttonElement.setAttribute(this.stateAttributes.ariaActiveDescendant, activeDescendantId);
                    }
                }
            }
        }
